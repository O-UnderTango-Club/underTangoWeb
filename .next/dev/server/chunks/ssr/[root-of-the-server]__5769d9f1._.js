...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://aygouubgvhkzpaxqsvvy.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF5Z291dWJndmhrenBheHFzdnZ5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ3NjIyMDEsImV4cCI6MjA4MDMzODIwMX0.3BffkujBvXVUZ3RyqdIxjCif9YLfd7OvXfcVTDKdCwM");
...
const AuthProvider = ({ children })=>{
    ...
    // REGISTER
    const register = async ({ email, password, first_name, last_name, username, phone })=>{
    ...
    const updatePassword = async (newPassword)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.updateUser({
...
"[project]/app/Android-module/FCM/FcmRegistration.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyC05s84tQfQbiJua0G0LHnQsZP76HqxMk4"),
    projectId: ("TURBOPACK compile-time value", "undertango"),
    messagingSenderId: ("TURBOPACK compile-time value", "21199358960"),
    appId: ("TURBOPACK compile-time value", "1:21199358960:web:6b751db7c333403057ab35")
};
const VAPID_KEY = ("TURBOPACK compile-time value", "BGocnouw1slcXhcq9WdgAzgPiTs1sZPQ4jxcK_efzpp5LFIXMBEsq42UQe8KO1zTaxZQy0tAfMQdvnRB3LH89_0");
...
async function handleFCMRegistration() {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSupported"])()) {
        console.warn("FCM no soportado.");
        return;
    }
    try {
        const messaging = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMessaging"])(app);
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$messaging$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])(messaging, {
            vapidKey: VAPID_KEY,
...
"[project]/app/Android-module/PWAServiceWorker.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Android$2d$module$2f$FCM$2f$FcmRegistration$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/Android-module/FCM/FcmRegistration.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if ("serviceWorker" in navigator) {
            window.addEventListener("load", ()=>{
                ...
                }).catch((err)=>console.error("Error registrando firebase-messaging-sw.js:", err));
            });
        }
    }, []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Android$2d$module$2f$FCM$2f$FcmRegistration$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/app/Android-module/PWAServiceWorker.tsx",
                lineNumber: 42,
                columnNumber: 7
            }, this),
            null
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5769d9f1._.js.map