...
function Header() {
    ...
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Header, "2TKL/lhffcEzIUEGHgqNfuLZ7fE=", false, function() {
    return [
...
"[project]/app/hooks/useHomeEffects.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useHomeEffects() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useHomeEffects.useEffect": ()=>{
            ...
            function changeText() {
                ...
                if (textElement) {
                    ...
                    setTimeout({
                        "useHomeEffects.useEffect.changeText": ()=>{
                            textElement.textContent = texts[currentIndex];
                            textElement.style.opacity = '1';
                            currentIndex = (currentIndex + 1) % texts.length;
                        }
                    }["useHomeEffects.useEffect.changeText"], 500);
                }
            }
            ...
            const observer = new IntersectionObserver({
                "useHomeEffects.useEffect": (entries)=>{
                    entries.forEach({
                        "useHomeEffects.useEffect": (entry)=>{
            ...
            }["useHomeEffects.useEffect"], observerOptions);
            sections.forEach({
                "useHomeEffects.useEffect": (section)=>observer.observe(section)
            }["useHomeEffects.useEffect"]);
            timelineItems.forEach({
                "useHomeEffects.useEffect": (item)=>observer.observe(item)
            }["useHomeEffects.useEffect"]);
        ...
        `;
            ...
            document.querySelectorAll('#navbar a[href^="#"]').forEach({
                "useHomeEffects.useEffect": (anchor)=>{
                    anchor.addEventListener('click', {
                        "useHomeEffects.useEffect": (e)=>{
                            e.preventDefault();
            ...
            function adjustImageSizes() {
                ...
                imageContainers.forEach({
                    "useHomeEffects.useEffect.adjustImageSizes": (container)=>{
                ...
                }["useHomeEffects.useEffect.adjustImageSizes"]);
                const clientLogos = document.querySelectorAll('.client-logos img');
                clientLogos.forEach({
                    "useHomeEffects.useEffect.adjustImageSizes": (logo)=>{
...
_s(useHomeEffects, "OD7bBpZva5O2jO+Puf00hKivP7c=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useHomeEffects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/hooks/useHomeEffects.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function HomePage() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useHomeEffects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHomeEffects"])();
...
_s(HomePage, "E9j1nwKNEpxE39zr1h9DwfqRNYQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useHomeEffects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHomeEffects"]
    ];
});
_c = HomePage;
var _c;
...
//# sourceMappingURL=app_9e274bc8._.js.map